...
from scrabbleScoreboard.api.resources import (
    ...
    GameListResource, GameResource,
    PlayResource, PlayListResource,
    PlayerResource, PlayerListResource,
    PlaysGameListResource, PlaysPlayerListResource
)
...
api.add_resource(WordLanguageListResource, '/words/languages', endpoint='languages')
...
# api.add_resource(PlaysGameListResource, '/games/<int:game_id>/plays', endpoint='plays')
...
api.add_resource(PlaysPlayerListResource, '/players/<string:name>/plays')
